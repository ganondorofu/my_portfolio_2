...
export const historyData: HistoryEntry[] = [
  {
    version: 'v1.5.0',
    date: '2025-09-04',
    description: '「更新履歴」アプリのデザインを刷新し、コミットIDを削除。日付も実際の開発期間に合わせて再編成しました。',
  },
  {
    version: 'v1.4.2',
    date: '2025-08-30',
    description: '背後にあるウィンドウをクリックしてフォーカスを当てると、ウィンドウが開き直るように見える問題を修正しました。',
  },
  {
    version: 'v1.4.1',
    date: '2025-08-28',
    description: 'ウィンドウのドラッグ操作後に、ウィンドウが元の位置にずれてしまう問題を修正しました。',
  },
  {
    version: 'v1.4.0',
    date: '2025-08-25',
    description: '新しいウィンドウが画面外に表示される問題と、ウィンドウ移動がぎこちない問題を修正し、操作性を改善しました。',
  },
  {
    version: 'v1.3.1',
    date: '2025-08-22',
    description: 'ウィンドウの重複表示バグと、ウィンドウが移動できない問題を修正し、アプリケーションの安定性を向上させました。',
  },
  {
    version: 'v1.3.0',
    date: '2025-08-18',
    description: 'ウィンドウの最小化機能が正常に動作しない問題を修正しました。',
  },
  {
    version: 'v1.2.0',
    date: '2025-08-15',
    description: 'ウィンドウの開閉、最大化・最小化にアニメーションを追加し、視覚的なフィードバックを向上させました。',
  },
  {
    version: 'v1.1.0',
    date: '2025-08-10',
